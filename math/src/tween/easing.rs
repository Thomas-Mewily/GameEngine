...
impl Easing {
    ...
    pub const fn retro(n : float) -> Self { Self::new(EasingFn::Round(n)) }
    ...
    pub const fn pow_in(n: float) -> Self { Self::new(EasingFn::PowIn(n)) }
    ...
    pub const fn pow_out(n: float) -> Self { Self::new(EasingFn::PowOut(n)) }
